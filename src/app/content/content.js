...
export const PageContent = {
  ...
  EventosContent: {
    ...
    subtitle: 'Enterate de todas nuestras experiencias: Círculos, encuentros, retiros y más.',
  },
  TratamientosContent: {
    title: 'Nuestros Servicios',
    subtitle: 'Sesiones y tratamientos individuales, práctica de yoga, rehabilitación. Todo lo que necesitas para gener bienestar completo.',
  }
}
  ...
  ClasesItemData: [
    {
      ...
      description: {
        p1: 'Ideal para principiantes o aquellos que quieren retomar su práctica, este pack te guiará a través de los conceptos fundamentales del yoga de una manera accesible y personalizada. ',
        p2: 'Cada clase está diseñada para introducir nuevas posturas, técnicas de respiración y principios filosóficos, permitiéndote construir una base sólida y desarrollar una práctica que se adapte a tus necesidades.',
        p3: 'Explora asanas (posturas) que fortalecen, estiran y equilibran tu cuerpo, mientras que las prácticas de meditación y respiración te ayudarán a reducir el estrés y a encontrar un mayor sentido de paz interior.',
        p4: 'Descubre la práctica del yoga con nuestro pack de 4 clases. Únete a nosotros y comienza a cultivar un estilo de vida más equilibrado y pleno.'
      },
      src: '/img/clases-1.png',
      alt: 'Pack de 4 clases de yoga',
      href: '',
    },
    {
      id: '2',
      title: 'Pack de 8 clases',
      description: {
        p1: 'Ideal para principiantes o aquellos que quieren retomar su práctica, este pack te guiará a través de los conceptos fundamentales del yoga de una manera accesible y personalizada. ',
        p2: 'Cada clase está diseñada para introducir nuevas posturas, técnicas de respiración y principios filosóficos, permitiéndote construir una base sólida y desarrollar una práctica que se adapte a tus necesidades.',
        p3: 'Explora asanas (posturas) que fortalecen, estiran y equilibran tu cuerpo, mientras que las prácticas de meditación y respiración te ayudarán a reducir el estrés y a encontrar un mayor sentido de paz interior.',
      ...
      src: '/img/clases-2.png',
      alt: 'Pack de 8 clases de yoga',
      href: '',
    },
    {
      id: '3',
      ...
      src: '/img/clases-3.png',
      alt: 'Pack personalizado de clases de yoga',
      href: '',
    }
  ],
  ...
  TratamientosItemData: [
    {
      ...
      description: {
        ...
        p3: 'Creo que no hay nada mas poderoso que conocerse. Al estudiar anatomía mi mente se abrió de par en par y me di cuenta que todos deberíamos tener ese conocimiento.',
        p4: ''
      },
      src: '/img/tratamientos-card.jpeg',
      alt: 'Tratamientos de rehabilitación y sanación.',
      href: '',
    },
    {
      id: '8',
      ...
      src: '/img/sesiones-individuales.jpeg',
      alt: 'Sesiones individuales 1:1 Autoconocimiento y bienestar',
      href: '',
    },
    {
      id: '9',
      ...
      description: {
        ...
        p2: 'Abordaremos el movimiento desde el centro de nuestra respiración siendo nuestra principal guía. Lo mas importante de todo es que escuches a tu cuerpo y te esfuerces sin forzar.',
        p3: '',
        p4: ''
      },
      src: '/img/practicas-yoga.jpeg',
      alt: 'Prácticas de yoga By Movimiento Consciente',
      href: '',
    },
  ],
}

export const ClasesVideoData = {
