                        ...
                        <div className="mx-auto max-w-7xl px-6 lg:px-8">
                            <div className="grid grid-cols-1 gap-12 lg:grid-cols-3 items-center justify-center p-4">
                                <div className="flex justify-center lg:col-span-2">
                                    <div className="relative rounded-2xl ring-toast-300 transition min-w-[38rem] w-full max-w-[42rem] h-[400px]">
                                        <Image
                                ...
                                <div className="flex justify-center lg:col-span-1">
                                    <div className="relative rounded-2xl ring-toast-300 transition min-w-[20rem] max-w-[28rem] h-[600px] ">
                                        <Image
                            ...
                            <div className="mt-6 lg:mt-0 grid grid-cols-1 gap-12 lg:grid-cols-2 items-center justify-center p-4 ">
                                <div className=" lg:w-full lg:max-w-lg p-8 flex flex-col justify-center px-8 border border-gray-300 shadow-lg rounded-2xl ring-toast-300 transition">
                                ...
                                <div className=" lg:w-full lg:max-w-lg p-8 flex flex-col justify-center px-8 border border-gray-300 shadow-lg rounded-2xl ring-toast-300 transition">
                                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Prácticas presenciales</h2>
                                    <p className="mt-6 text-xl leading-8 text-gray-600">
                                    Podés reservar tu lugar para clases presenciales.
                                    En THE ISLAND WELLNESS, Port d’ Andratx. 
                                    </p>
                            ...
                            <div className="mt-6 lg:mt-0 flex items-center justify-end p-4 ">
                                <div className="relative rounded-2xl ring-toast-300 transition w-[56rem] max-w-[42rem]  lg:max-w-[56rem] h-[500px]">
                                    <Image
